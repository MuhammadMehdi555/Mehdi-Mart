...
<head>
    ...
    <title>Order Success - Mehdi Mart</title>
...
$wishlist_count = $row_wish['total'];
        ...
        <!-- ORDER SUCCESS MAIN CONTENT -->
        <main class="max-w-4xl mx-auto px-4 py-16 text-center">
            <div class="bg-white shadow rounded-lg p-10">
                <h1 class="text-3xl font-bold text-green-600">Thank you! Your order has been placed.</h1>
                <p class="mt-2 text-gray-600">We've emailed the order details to you. You can view your orders in <a
                        href="profile.php" class="text-orange-600 hover:underline">Your Account</a>.</p>
                <a href="index.php"
                    class="mt-6 inline-block bg-orange-600 text-white px-6 py-2 rounded hover:bg-orange-700 transition">Continue
                    Shopping</a>
            </div>
        </main>
