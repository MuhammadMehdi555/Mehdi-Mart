...
<head>
    ...
    <title>Mehdi Mart - Terms & Conditions</title>
...
$wishlist_count = $row_wish['total'];
        ...
        <main class="bg-white rounded-lg shadow p-6">
            ...
            <p class="text-gray-700 mb-4">
                Welcome to <span class="font-semibold text-orange-600">Mehdi Mart</span>. These Terms and Conditions
                outline the rules and regulations for using our website.
            </p>

            <h2 class="text-xl font-semibold mt-6 mb-2">1. General Information</h2>
            <p class="text-gray-700 mb-4">
                Mehdi Mart is a practice e-commerce website created by <strong>Muhammad Mehdi</strong> for learning and
                demonstration purposes.
                The website simulates the shopping experience but does not process real orders or payments.
            </p>

            <h2 class="text-xl font-semibold mt-6 mb-2">2. Product Information</h2>
            <p class="text-gray-700 mb-4">
                All product names, prices, images, and descriptions displayed on this website are for
                <strong>educational and sample purposes only</strong>.
                They do not represent real or purchasable items.
            </p>

            <h2 class="text-xl font-semibold mt-6 mb-2">3. User Accounts</h2>
            <ul class="list-disc ml-5 text-gray-700 space-y-2">
                <li>Users can register an account to explore checkout and order functionality.</li>
                <li>All user data (email, password, etc.) is stored securely for demo purposes only.</li>
                <li>Please avoid using sensitive or personal data during signup.</li>
            </ul>

            <h2 class="text-xl font-semibold mt-6 mb-2">4. Orders and Checkout</h2>
            <ul class="list-disc ml-5 text-gray-700 space-y-2">
                <li>Any order placed on Mehdi Mart is <strong>not real</strong> and will not result in physical
                    delivery.</li>
                <li>Orders are saved to demonstrate backend PHP & MySQL functionality.</li>
                <li>Each order entry helps test database insert, fetch, and delete operations.</li>
            </ul>

            <h2 class="text-xl font-semibold mt-6 mb-2">5. Intellectual Property</h2>
            <p class="text-gray-700 mb-4">
                The website layout, structure, and custom backend code are created by
                <strong>Muhammad Mehdi</strong>.
                Some frontend design elements may come from publicly available templates and are used for learning
                purposes.
            </p>

            <h2 class="text-xl font-semibold mt-6 mb-2">6. Limitations of Use</h2>
            <ul class="list-disc ml-5 text-gray-700 space-y-2">
                <li>Do not attempt to harm or misuse the website or its database.</li>
                <li>Do not upload or share any illegal, harmful, or copyrighted content.</li>
                <li>This project is for educational purposes — not for commercial use.</li>
            </ul>

            <h2 class="text-xl font-semibold mt-6 mb-2">7. Privacy & Data</h2>
            <p class="text-gray-700 mb-4">
                All user data is handled responsibly and used only to demonstrate form handling,
                session management, and authentication in PHP.
                No personal data is shared or used outside this demo project.
            </p>

            <h2 class="text-xl font-semibold mt-6 mb-2">8. Contact</h2>
            <p class="text-gray-700 mb-4">
                If you have questions regarding these Terms or this practice project,
                please contact me at:
                <a href="mailto:muhammdmehdi0555@gmail.com" class="text-orange-600 font-medium hover:underline">
                    muhammdmehdi0555@gmail.com
                </a>
            </p>

            <p class="text-gray-600 italic mt-8">
                <strong>Note:</strong> This website is a <span class="text-orange-600">practice project</span> only and
                does not represent a real online store. All rights belong to the developer.
            </p>
        </main>
