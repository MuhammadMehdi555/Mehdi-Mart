...
$wishlist_count = $row_wish['total'];
        ...
        <main class="max-w-7xl mx-auto px-4 py-12 space-y-16">
            ...
            <section class="text-center">
                <h1 class="text-3xl font-bold">About Mehdi Mart</h1>
                <p class="mt-2 text-gray-600 max-w-2xl mx-auto">
                    Hi, I'm <span class="font-semibold text-orange-600">Muhammad Mehdi</span>.
                    This website, <strong>Mehdi Mart</strong>, has been created purely for
                    <span class="text-orange-600 font-medium">practice and learning purposes</span>.
                    The project started on <strong>13 June 2025</strong> and is part of my journey
                    to improve my backend development skills using PHP and MySQL.
                </p>
            </section>
            ...
            <section class="grid md:grid-cols-2 gap-8 items-center">
                <?php
    $select_img=mysqli_query($connect,"SELECT * FROM admin");
    $row_img=mysqli_fetch_assoc($select_img);
    ?>
                <img src="images/<?php echo $row_img['image']?>" alt="Mehdi Mart Project" class="rounded-lg shadow">
                <div>
                    <h2 class="text-2xl font-semibold">Project Overview</h2>
                    <p class="mt-4 text-gray-700 leading-relaxed">
                        <strong>Mehdi Mart</strong> is a self-practice e-commerce project developed by me
                        to explore real-world website functionality — like user registration, login system,
                        product management, and order checkout.
                    </p>
                    <p class="mt-3 text-gray-700 leading-relaxed">
                        The <span class="font-medium text-orange-600">frontend design</span> of this website
                        is not fully my own — I used a pre-designed layout for structure and styling to save time.
                        However, all the <span class="font-medium text-orange-600">backend development</span>
                        (database setup, PHP logic, session handling, file uploads, and CRUD operations)
                        has been done completely by me.
                    </p>
                </div>
            </section>
            ...
            <!-- Skills Practiced -->
            <section>
                <h2 class="text-2xl font-semibold text-center">What I Learned from This Project</h2>
                <div class="grid md:grid-cols-3 gap-6 mt-6">
                    <div class="p-6 bg-white shadow rounded-lg text-center hover:shadow-lg transition">
                        <i class="fas fa-server text-orange-600 text-2xl mb-3"></i>
                        <h3 class="font-bold">Backend Development</h3>
                        <p class="mt-2 text-gray-600">PHP, MySQL, and server-side logic implementation.</p>
                    </div>
                    <div class="p-6 bg-white shadow rounded-lg text-center hover:shadow-lg transition">
                        <i class="fas fa-user-shield text-orange-600 text-2xl mb-3"></i>
                        <h3 class="font-bold">Authentication System</h3>
                        <p class="mt-2 text-gray-600">Login, signup, session handling, and secure password storage.</p>
                    </div>
                    <div class="p-6 bg-white shadow rounded-lg text-center hover:shadow-lg transition">
                        <i class="fas fa-shopping-cart text-orange-600 text-2xl mb-3"></i>
                        <h3 class="font-bold">E-Commerce Logic</h3>
                        <p class="mt-2 text-gray-600">Cart, wishlist, and order management system functionality.</p>
                    </div>
                </div>
            </section>

            <!-- Message -->
            <section class="text-center bg-orange-600 text-white py-12 rounded-lg">
                <h2 class="text-2xl font-bold">This Website is for Practice Only</h2>
                <p class="mt-3 text-white/90 max-w-2xl mx-auto">
                    All products, data, and information shown here are for
                    <strong>educational and practice purposes only</strong>.
                    This website is not a real store.
                </p>
                <a href="index.php"
                    class="mt-5 inline-block bg-white text-orange-600 font-semibold px-6 py-3 rounded hover:bg-gray-100 transition">
                    Back to Home
                </a>
            </section>
        ...
        document.getElementById('catToggle').addEventListener('click', () => {
            document.getElementById('catList').classList.toggle('hidden');
        });
        </script>
