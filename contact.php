...
<head>
    ...
    <title>Contact - Mehdi Mart</title>
...
$wishlist_count = $row_wish['total'];
        ...
        <div class="max-w-7xl mx-auto px-4 mt-6 ">
            <main class="grid grid-cols-1 md:grid-cols-1 gap-6 mb-12">
                <!-- Contact Form -->
                <div class="bg-white shadow  rounded-lg p-6">
                    <h2 class="text-2xl font-bold text-gray-800 mb-4">Get in Touch</h2>
                    <form class="space-y-4" method="POST" action="contact-submit.php">
                        <input type="text" placeholder="Your Name" name="name"
                            class="w-full border rounded px-3 py-2 focus:ring-2 focus:ring-orange-400 outline-none"
                            required>
                        ...
                        <textarea placeholder="Message" rows="6" name="message"
                            ...
                            required></textarea>
                        <button type="submit"
                            class="w-full bg-orange-600 text-white py-2 rounded hover:bg-orange-700 transition">Send
                            Message</button>
                    </form>
                </div>
                <!-- Map / Location -->
