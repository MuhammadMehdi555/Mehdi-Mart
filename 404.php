...
$wishlist_count = $row_wish['total'];
        ...
        ?>
          ...
          ?>
                ...
                <div class="relative">
                    ...
                    <div id="profileMenu" class="absolute right-0 mt-2 w-48 bg-white border rounded shadow-md hidden">
        ...
        <nav class="hidden md:flex bg-orange-600 text-white px-6 py-2 space-x-6 text-sm md:text-base">
            ...
            <a href="shope.php" class="hover:underline">Shop</a>
    ...
    <!-- MAIN 404 CONTENT -->
    <main class="min-h-[60vh] flex items-center justify-center px-4 mt-6">
        <div class="text-center">
            <h1 class="text-6xl font-bold text-orange-600">404</h1>
            <p class="mt-4 text-lg">Oops! Page not found.</p>
            <a href="index.php"
                class="mt-6 inline-block bg-orange-600 text-white px-6 py-3 rounded hover:bg-orange-700">Go Home</a>
        </div>
    </main>
